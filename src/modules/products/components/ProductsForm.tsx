...
export function ProductsForm() {
    ...
    return (
        <ShadForm.Form {...form}>
            <form onSubmit={onSubmit} className='space-y-6 p-6 bg-white rounded-lg shadow-md'>
                {/* Información del producto */}
                <fieldset className='border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm'>
                    <legend className='px-2 text-xl font-medium text-gray-700 bg-white'>Información del producto</legend>
                ...
                {/* Precios de compra */}
                <fieldset className='border border-gray-200 rounded-lg p-4 md:p-6 shadow-sm'>
                    <legend className='px-2 text-xl font-medium text-gray-700 bg-white'>Precios</legend>
