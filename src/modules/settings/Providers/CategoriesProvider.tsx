import { useCategoryActions, useCategoriesStore } from "../stores/categoriesStore";
...
const CategoriesCtx = createContext({} as {
...
export function CategoriesProvider({ children }: { children: ReactNode }) {
    ...
    const [editDefaultValues, setEditDefaultValues] = useState<CategoryData | null>(null)

    const { categories, filters, pagination } = useCategoriesStore()
    const { addCategory, deleteCategory, loadCategories, updateCategory } = useCategoryActions()
