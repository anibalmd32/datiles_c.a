...
export const featureCardItems: FeatureCardItem[] = [
    {
        ...
        description: 'Altamente configurable para una experiencia mas personalizada',
        benefits: [
            'Gestiona tu usuario',
    ...
    {
        title: 'Genera ventas',
        description: 'El resultado final es el aumento de las ventas y el alcance de tu negocio',
        benefits: [
